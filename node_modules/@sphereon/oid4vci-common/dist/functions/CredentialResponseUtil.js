...
function acquireDeferredCredential({ bearerToken, transactionId, deferredCredentialEndpoint, deferredCredentialIntervalInMS, deferredCredentialAwait, }) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (!((_a = credentialResponse.successBody) === null || _a === void 0 ? void 0 : _a.credential) && deferredCredentialAwait) {
...
function acquireDeferredCredentialImpl({ bearerToken, transactionId, deferredCredentialEndpoint, }) {
    return __awaiter(this, void 0, void 0, function* () {
