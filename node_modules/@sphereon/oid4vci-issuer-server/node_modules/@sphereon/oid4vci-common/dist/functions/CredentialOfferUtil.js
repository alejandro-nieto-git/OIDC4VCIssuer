...
function determineSpecVersionFromURI(uri) {
    ...
    version = getVersionFromURIParam(uri, version, types_1.OpenId4VCIVersion.VER_1_0_11, 'credential_offer_uri=');
    version = getVersionFromURIParam(uri, version, types_1.OpenId4VCIVersion.VER_1_0_11, 'credential_issuer');
    version = getVersionFromURIParam(uri, version, types_1.OpenId4VCIVersion.VER_1_0_11, 'grants');
    if (version === types_1.OpenId4VCIVersion.VER_UNKNOWN) {
        version = types_1.OpenId4VCIVersion.VER_1_0_11;
    }
    return version;
}
...
const getClientIdFromCredentialOfferPayload = (credentialOffer) => {
    ...
    if (state && isJWT(state)) {
        const decoded = (0, jwt_decode_1.default)(state, { header: false });
...
const getStateFromCredentialOfferPayload = (credentialOffer) => {
    ...
    if ('grants' in credentialOffer) {
        ...
        else if ((_b = credentialOffer.grants) === null || _b === void 0 ? void 0 : _b['urn:ietf:params:oauth:grant-type:pre-authorized_code']) {
            return (_d = (_c = credentialOffer.grants) === null || _c === void 0 ? void 0 : _c['urn:ietf:params:oauth:grant-type:pre-authorized_code']) === null || _d === void 0 ? void 0 : _d['pre-authorized_code'];
        }
    }
