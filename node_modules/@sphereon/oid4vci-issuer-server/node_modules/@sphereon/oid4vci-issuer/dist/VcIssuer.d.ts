import { CNonceState, CreateCredentialOfferURIResult, CredentialDataSupplierInput, CredentialIssuerMetadataOpts, CredentialOfferFormat, CredentialOfferSession, CredentialRequestV1_0_11, CredentialResponse, Grant, IStateManager, JsonLdIssuerCredentialDefinition, JWTVerifyCallback, QRCodeOpts, URIState } from '@sphereon/oid4vci-common';
...
export declare class VcIssuer<DIDDoc extends object> {
    ...
    private readonly _userPinRequired;
    ...
    constructor(issuerMetadata: CredentialIssuerMetadataOpts, args: {
    ...
    get issuerMetadata(): CredentialIssuerMetadataOpts;
}
