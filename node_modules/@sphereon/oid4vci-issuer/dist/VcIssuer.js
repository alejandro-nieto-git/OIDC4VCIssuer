...
class VcIssuer {
    ...
    updateErrorStatus({ preAuthorizedCode, error, issuerState, }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (preAuthorizedCode) {
    ...
    validateCredentialRequestProof({ credentialRequest, jwtVerifyCallback, tokenExpiresIn, }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const alg = (_a = jwtVerifyResult.alg) !== null && _a !== void 0 ? _a : header.alg;
                const kid = (_b = jwtVerifyResult.kid) !== null && _b !== void 0 ? _b : header.kid;
                const jwk = (_c = jwtVerifyResult.jwk) !== null && _c !== void 0 ? _c : header.jwk;
                const x5c = (_d = jwtVerifyResult.x5c) !== null && _d !== void 0 ? _d : header.x5c;
                ...
                // protected resource.)
                if (!iss && ((_f = (_e = authSession === null || authSession === void 0 ? void 0 : authSession.credentialOffer.credential_offer) === null || _e === void 0 ? void 0 : _e.grants) === null || _f === void 0 ? void 0 : _f.authorization_code)) {
