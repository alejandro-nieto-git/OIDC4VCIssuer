...
class VcIssuerBuilder {
    ...
    addCredentialsSupported(credentialSupported) {
        var _a;
        this.issuerMetadata.credentials_supported = [...((_a = this.issuerMetadata.credentials_supported) !== null && _a !== void 0 ? _a : []), credentialSupported];
        return this;
    }
    withUserPinRequired(userPinRequired) {
    ...
    build() {
        ...
        metadata.credentials_supported = [...((_b = this.issuerMetadata.credentials_supported) !== null && _b !== void 0 ? _b : []), ...((_c = builder === null || builder === void 0 ? void 0 : builder.credentials_supported) !== null && _c !== void 0 ? _c : [])];
        metadata.display = [...((_d = this.issuerMetadata.display) !== null && _d !== void 0 ? _d : []), ...((_e = builder === null || builder === void 0 ? void 0 : builder.display) !== null && _e !== void 0 ? _e : [])];
        ...
        return new VcIssuer_1.VcIssuer(metadata, {
            userPinRequired: (_f = this.userPinRequired) !== null && _f !== void 0 ? _f : false,
